...
namespace nexus {
  ...
  std::pair<G4int, G4double*> HamamatsuS133605075HQR::GetSensareaEnergyArray(){
    G4double* energy = new double[]{opticalprops::optPhotMinE_, h_Planck*c_light/(285.25*nm), h_Planck*c_light/(286.58*nm), 
  ...
  std::pair<G4int, G4double*> HamamatsuS133605075HQR::GetSensareaEfficiencyArray(){
    G4double* efficiency = new double[]{0.000, 0.127, 0.155, 0.178, 0.215, 0.255, 0.269, 0.297, 0.311, 0.325, 0.339, 0.355, 
