...
namespace nexus {
  ...
  // Plate dimensions should just refer to config_code_==1.
    ...
    G4double DFA_frame_reflectivity_;                               ///< Reflectivity (flat) of the FR4 DFA frame in the visible light spectrum, i.e. in the [400, 700] nm range. It only makes a difference if DFA_frame_is_vikuiti_coated_==False.
