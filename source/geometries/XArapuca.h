...
namespace nexus {
  ...
  // Plate dimensions should just refer to config_code_==1.
    ...
    G4double frame_width_along_wlsplength_;                         ///< Frame dimension along the length of the X-ARAPUCA
    G4double frame_width_along_wlspwidth_;                          ///< Frame dimension along the width of the X-ARAPUCA
